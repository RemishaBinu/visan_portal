  ...
  Widget build(BuildContext context) {
    ...
    borderRadius: BorderRadius.circular(5)
              ...
              Expanded(
                flex: 4,
                child: TextField(
                  decoration: InputDecoration(hintText: '(+91) 415 5552671', hintStyle: TextStyle(color: Color.fromARGB(255, 160, 160, 160)),
              ...
              CustomTextField(label: 'Highest Career level', hint: 'Select', sIcon: Icons.keyboard_arrow_down),
             CustomTextField(label: 'Years of Experience', hint: 'Select', sIcon: Icons.keyboard_arrow_down),
