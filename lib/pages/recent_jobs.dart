...
class RecentJobsState extends State<RecentJobs>{
  ...
  List<Widget>getListItems(){
    return jobItems
      .map((jobItem) => JobListItem(jobItem: jobItem))
      .toList();
  }

  getButtonColor(bool isPrimary){
    return isPrimary
      ? MaterialStateProperty.all<Color>(const Color.fromARGB(255, 191, 231, 255))
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                        ...
                        foregroundColor: MaterialStateProperty.all<Color>(const Color.fromARGB(255, 11, 88, 131)),
