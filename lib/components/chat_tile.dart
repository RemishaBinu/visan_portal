          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color:(chatChannel.unRead != null)? Color.fromARGB(255, 12, 168, 79):Color.fromARGB(255, 252, 251, 251),
              ),

              //  margin: EdgeInsets.all(5),
              child: Text(
                  (chatChannel.unRead != null) ? ('${chatChannel.unRead}') : '',
                  style: TextStyle(
                      color: Colors.white,
                      fontSize: 12,
                      fontFamily: 'Open Sans',
            ...
            Container(
              child: Text(chatChannel.dateString,
                  style: TextStyle(
                      color: Color.fromARGB(255, 117, 117, 117), fontSize: 12)),
            )
          ],
        ))
      ],
