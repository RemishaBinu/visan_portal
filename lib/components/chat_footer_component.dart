  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(
        border: Border(top: BorderSide(color: Color.fromARGB(255, 220, 220, 220), width: 1))
      ),
      child: Row(
        children: [
          Container(
          ...
          Container(
            ...
            child: const Icon(Icons.attach_file_rounded, color: Colors.black45)
          ),
          InkWell(
            child: Container(
              padding: const EdgeInsets.only(top: 10, bottom: 10, right: 10),
              child: const Icon(Icons.send_rounded, color: Color.fromARGB(255, 47, 142, 194))
            ),
            onTap: () {
