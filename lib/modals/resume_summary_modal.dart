...
class ResumeSummaryModal extends StatelessWidget{
  @override
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: const [
                  Expanded(child: Text("Personal Details", style: TextStyle(fontSize: 19, color: Color.fromARGB(255, 11, 88, 131), fontWeight: FontWeight.bold),)),
                  Icon(Icons.edit_outlined, color: Color.fromARGB(255, 11, 88, 131))
                ],
              ),
            ),
            Container(
            ...
            Container(
              ...
              child: Row(
                children: const [
                  Expanded(child: Text("Educational Details", style: TextStyle(fontSize: 19, color: Color.fromARGB(255, 11, 88, 131), fontWeight: FontWeight.bold),)),
                  Icon(Icons.edit_outlined, color: Color.fromARGB(255, 11, 88, 131))
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Row(
                children: const [
                  Expanded(child: Text("Skills", style: TextStyle(fontSize: 19, color: Color.fromARGB(255, 11, 88, 131), fontWeight: FontWeight.bold),)),
                  Icon(Icons.edit_outlined, color: Color.fromARGB(255, 11, 88, 131))
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Row(
                children: const [
                  Expanded(child: Text("Experiences", style: TextStyle(fontSize: 19, color: Color.fromARGB(255, 11, 88, 131), fontWeight: FontWeight.bold),)),
                  Icon(Icons.edit_outlined, color: Color.fromARGB(255, 11, 88, 131))
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Row(
                children: const [
                  Expanded(child: Text("Certifications", style: TextStyle(fontSize: 19, color: Color.fromARGB(255, 11, 88, 131), fontWeight: FontWeight.bold),)),
                  Icon(Icons.edit_outlined, color: Color.fromARGB(255, 11, 88, 131))
                ],
              ),
            ),
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: const [
                      Expanded(child: const Text("Android Developer Certification", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold))),
            ...
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: const [
                      Expanded(child: const Text("Software designer", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold))),
                      Icon(Icons.delete_outline_rounded)
                    ],
                  ),
                  Row(
            ...
            Container(
              ...
              child: Row(
                children: const [
                  Expanded(child: Text("Pattents", style: TextStyle(fontSize: 19, color: Color.fromARGB(255, 11, 88, 131), fontWeight: FontWeight.bold),)),
                  Icon(Icons.edit_outlined, color: Color.fromARGB(255, 11, 88, 131))
                ],
              ),
            ),
            Container(
              ...
              child: Column(
                children: [
                  Row(
                    children: const [
                      Expanded(child: const Text("Online Education System", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold))),
                      Icon(Icons.delete_outline_rounded)
                    ],
                  ),
                  Row(
